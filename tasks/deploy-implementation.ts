...
task("deploy-implementation")
    ...
    .setAction(async ({ name: contractName }: TaskParams, { ethers, upgrades, network, run }) => {
        ...
        const implementationAddress = await upgrades.deployImplementation(ContractFactory);
